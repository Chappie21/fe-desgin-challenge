...
export const socialNetworks:ISocialNetwork[] = [
    {
        name: 'facebook',
        image: 'https://chicksgold.com/icons/facebook.svg',
        url: 'https://www.facebook.com/Chicksgroup/'
    }, 
    {
        name: 'instagram',
        image: 'https://chicksgold.com/icons/instagram.svg',
        url: 'https://www.instagram.com/chicksgold/'
    },
    {
        name: 'twitter',
        image: 'https://chicksgold.com/icons/twitter.svg',
        url: 'https://twitter.com/chicksgold'
    },
    {
        name: 'discord',
        image: 'https://chicksgold.com/icons/discord.svg',
